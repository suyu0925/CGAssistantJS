const Items = [
  { name: '魔石', id: 18005, type: 26, maxCount: 0, sellPrice: 12, desc: '魔族力量的来源', memo: '12块的绿色魔石' },
  { name: '魔石', id: 18028, type: 26, maxCount: 0, sellPrice: 96, desc: '魔族力量的来源', memo: '96块的蓝色魔石' },
  { name: '火的水晶碎片', id: 18312, type: 26, maxCount: 99, sellPrice: 0, desc: '火的水晶碎片', memo: '火的水晶碎片' },
  { name: '猎人推荐信', id: 18142, type: 26, maxCount: 0, sellPrice: 0, desc: '猎人的就职推荐信', memo: '猎人就职道具' },
  // {
  //   name: '猎人推荐信',
  //   info: '$4猎人的就职推荐信\n$1放地上便会消失\n$1无法用宠物邮件传送',
  //   attr: '$4等级 1\n$0种类 不明',
  ...
  //   assessed: true
  // }
  { name: '卡片？', id: 14925, type: 41, maxCount: 0, sellPrice: 1, desc: '', memo: '未鉴定的穴熊卡片' },
]

module.exports = {
  Items,
  waitFor: async (itemName) => {
    while (true) {
      const item = cga.getInventoryItems()
      if (item.find(i => i.name === itemName)) {
        break
      }
  ...
  dropByName: (name) => {
    const items = cga.getInventoryItems().filter(i => i.name === name)
    items.forEach(item => {
      console.log(item)
